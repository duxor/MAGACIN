        ...
        function noviKorisnik(korisnik){
            ...
            '<hr><div id="hide" class="form-horizontal fontResize"style="margin-top: 50px">'+
                '<div class="col-sm-5">'+
                    ...
                    (korisnik?'<input id="id_korisnika" name="id" value="'+korisnik['id']+'" hidden>':'')+
                ...
                '<div class="col-sm-offset-1 col-sm-6">'+
                    '<div class="form-group">' +
                        ...
                        '<div class="col-sm-8"><input name="naziv" value="'+(korisnik?korisnik['naziv']?korisnik['naziv']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Adresa</label>' +
                        '<div class="col-sm-8"><input name="adresa" value="'+(korisnik?korisnik['adresa']?korisnik['adresa']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Grad</label>' +
                        '<div class="col-sm-8"><input name="grad" value="'+(korisnik?korisnik['grad']?korisnik['grad']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">JIB</label>' +
                        '<div class="col-sm-8"><input name="jib" value="'+(korisnik?korisnik['jib']?korisnik['jib']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">PIB</label>' +
                        '<div class="col-sm-8"><input name="pib" value="'+(korisnik?korisnik['pib']?korisnik['pib']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">PDV</label>' +
                        '<div class="col-sm-8"><input name="pdv" value="'+(korisnik?korisnik['pdv']?korisnik['pdv']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Ziro račun 1</label>' +
                        '<div class="col-sm-8"><input name="ziro_racun_1" value="'+(korisnik?korisnik['ziro_racun_1']?korisnik['ziro_racun_1']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Banka 1</label>' +
                        '<div class="col-sm-8"><input name="banka_1" value="'+(korisnik?korisnik['banka_1']?korisnik['banka_1']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Ziro račun 2</label>' +
                        '<div class="col-sm-8"><input name="ziro_racun_2" value="'+(korisnik?korisnik['ziro_racun_2']?korisnik['ziro_racun_2']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Banka 2</label>' +
                        '<div class="col-sm-8"><input name="banka_2" value="'+(korisnik?korisnik['banka_2']?korisnik['banka_2']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Registracija</label>' +
                        '<div class="col-sm-8"><input name="registracija" value="'+(korisnik?korisnik['registracija']?korisnik['registracija']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Broj upisa</label>' +
                        '<div class="col-sm-8"><input name="broj_upisa" value="'+(korisnik?korisnik['broj_upisa']?korisnik['broj_upisa']:'':'')+'" class="form-control"></div>' +
                    '</div>' +
                    '<div class="form-group">' +
                        '<label class="col-sm-4">Opis</label>' +
                        '<div class="col-sm-8"><textarea name="opis" class="form-control">'+(korisnik?korisnik['opis']?korisnik['opis']:'':'')+'</textarea></div>' +
                    '</div>' +
                    '<div class="form-group">' +
            ...
            $.post('/administracija/korisnici/ucitaj',
                    ...
                    function(data){
                        ...
                        var ispis='<style>table *{font-size:14px}</style>' +
                                ...
                                '<thead>' +
                                '<tr><th></th><th>Prezime i Ime</th><th>JMBG</th><th>Adresa</th><th>Grad</th><th>Naziv</th><th>PIB</th><th>Opis</th><th>Aktivan</th><th></th><th></th></tr>' +
                                '</thead>' +
                                '<tbody>';
                        for(var i=0;i<korisnici.length;i++){
                            ...
                            '<td>'+(korisnici[i]['grad']?korisnici[i]['grad']:'')+'</td>' +
                            '<td>'+(korisnici[i]['naziv']?korisnici[i]['naziv']:'')+'</td>' +
                            '<td>'+(korisnici[i]['pib']?korisnici[i]['pib']:'')+'</td>' +
