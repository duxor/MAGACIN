            ...
            <tbody>
                @foreach($magacini as $m)
                    <tr>
                        ...
                        <td>{{$m['opis']}}</td>
                        <td>
                            <a href="/administracija/magacin/azuriraj/{{$m['id']}}" class="btn btn-lg btn-info"><span class="glyphicon glyphicon-pencil"></span> Ažuriraj</a>
                            <a href="/administracija/magacin/ukloni/{{$m['id']}}" class="btn btn-lg btn-danger"><span class="glyphicon glyphicon-trash"></span> Ukloni</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
